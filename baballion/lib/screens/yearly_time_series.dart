...
class BarChartY extends StatefulWidget {
...
class _BarChartState extends State<BarChartY> with SingleTickerProviderStateMixin {
  double fraction = 0;
  ...
  @override
  void didUpdateWidget(BarChartY oldWidget) {
...
class BarChartPainterY extends CustomPainter {
  final List<int> ticks;
  final List<String> features;
  final List<List<num>> data;
  final List<String>? graphNames;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    features.asMap().forEach((index, feature) {
      ...
      canvas.save();
      canvas.translate(xOffset + barWidth / 6, axisHeight + 10); 
  ...
  @override
  bool shouldRepaint(BarChartPainterY oldDelegate) {
