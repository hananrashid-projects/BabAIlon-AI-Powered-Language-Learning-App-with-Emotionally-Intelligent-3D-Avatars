  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 z-10 flex justify-between p-4 flex-col">
      <div className="self-start">
        <img src="/logo.png" alt="BabAilon Logo" className="h-32 w-auto mx-auto" />
      </div>

      {/* Menu button (top-right) */}
      <div style={menuStyles}>
        <button className="menu-button" onClick={toggleMenu} style={buttonStyles}>
          <FaEllipsisV size={30} />
        </button>

        {/* If the menu is open, show the game buttons */}
        {isMenuOpen && (
          <div className="games-menu" style={gamesMenuStyles}>
            <Link to={buildGameURL("vocabulary_game")} style={{ textDecoration: "none" }}>
              <button className="game-button" style={gameButtonStyles}>
                <FaRegFutbol size={25} />
                <span>Vocabulary Game</span>
              </button>
            </Link>

            <Link to={buildGameURL("debate_game")} style={{ textDecoration: "none" }}>
              <button className="game-button" style={gameButtonStyles}>
                <FaRegFutbol size={25} />
                <span>Debate Game</span>
              </button>
            </Link>

            <Link to={buildGameURL("sentence_scramble")} style={{ textDecoration: "none" }}>
              <button className="game-button" style={gameButtonStyles}>
                <FaEdit size={25} />
      ...
      <div className="w-full flex flex-col items-end justify-center gap-4">
        <button
          onClick={saveScoreToFirebase}  // Save button
...
<button
  onClick={() => {
    ...
    // Option 2: Redirect to home page or another screen
    // window.location.href = `${originParam}/#/home`;
